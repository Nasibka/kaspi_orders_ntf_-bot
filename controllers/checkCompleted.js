...
async function checkCompleted(){
    ...
    axios.get('https://kaspi.kz/shop/api/v2/orders?page[number]=0&page[size]=1000&filter[orders][state]=ARCHIVE&filter[orders][status]=COMPLETED&filter[orders][creationDate][$ge]='+date, {
        headers: headers
    })
    .then(async response=>{
        ...
        if(data.length!==0){
            data.forEach(async order=>{
                ...
                if(o){
                    if(o.step ==='PICKUP'|| o.step ==='DELIVERY'
                    ||o.step ==='KASPI_DELIVERY'){
                        ...
                        console.log(o.order_id+' order udated (COMPLETED)')
