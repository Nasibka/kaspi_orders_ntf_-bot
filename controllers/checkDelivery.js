...
async function checkDelivery(){
    ...
    axios.get('https://kaspi.kz/shop/api/v2/orders?page[number]=0&page[size]=1000&filter[orders][state]=DELIVERY&filter[orders][creationDate][$ge]='+date, {
        headers: headers
    })
    .then(async response=>{
            ...
            data.forEach(async order=>{
                ...
                if(o){
                    if(o.step ==='new'||o.step ==='SIGN_REQUIRED'){
                        ...
                        console.log(o.order_id+' order udated (DELIVERY)')
                        ...
                        const total_price = parseInt(o.total_price.replace(" ",''))+parseInt(delivery_cost)
                        console.log(o.order_id+' total price:'+total_price)
                        ...
                        await addCell(o.order_id,'Курьер','1000') 
                        await addCell(o.order_id,'Город',o.town)
                        await addCell(o.order_id,'Цена продажи',total_price)
